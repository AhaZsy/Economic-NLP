...
# # 读取实体识别结果文件
# ner_results = pd.read_csv("/home/zsy/NER/ARTICLES_NER_Final.csv")
...
# valid_entity = []
# for i in valid_entities:
#     valid_entity.append(i.lower())
# # print(valid_entity)

# invalid_entities = set(firm_dict["FFI48 (Industry type)"])
...
#                                            })
#         elif entity in invalid_entities:
...
# # # 将结果存储到CSV文件中
# processed_results.to_csv("result_01_sentence.csv", index=False,encoding='utf-8-sig' )
...
# 将结果存储到CSV文件中
processed_results.to_csv("Article_Result_01.csv", index=False, encoding='utf-8-sig')

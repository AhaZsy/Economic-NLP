...
# Load data
article_data = pd.read_csv("/home/zsy/NER/Article_Result_01.csv")
...
# Save results to CSV
result_01_df.to_csv("result_01_Article.csv", index=False, encoding='utf-8-sig')
result_02_df.to_csv("result_02_Article.csv", index=False, encoding='utf-8-sig')
